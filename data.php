						...
						while($row = mysqli_fetch_assoc($sql)){ // fetch query yang sesuai ke dalam array
							...
							echo '
								...
								<td>
									...
									<a href="hapus.php?aksi=delete&nik='.$row['nik'].'" title="Hapus Data" data-toggle="tooltip" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nama'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
								</td>
							</tr>
							';
